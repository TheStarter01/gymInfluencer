function HowToUse() {
  return (
    <div className="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
      <h2 className="text-center font-md text-zinc-500">Pipeline</h2>
      <p className="mx-auto mt-2 max-w-lg text-balance text-center text-4xl font-semibold tracking-wider text-violet-300 sm:text-5xl">
        Behind the Scenes of Simplicity
      </p>
      <p className="mx-auto text-center mt-6 text-lg/8 text-pretty text-sm font-sm text-zinc-400">
        A closer look at how our process works for you.
      </p>
      <div className="mt-10 grid gap-4 sm:mt-16 lg:grid-cols-3 lg:grid-rows-2">
        <div className="relative lg:row-span-2">
          ...
          <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] lg:rounded-l-[calc(2rem+1px)]">
            <div className="px-8 pb-3 pt-8 sm:px-10 sm:pb-0 sm:pt-10">
              <p className="mt-2 text-lg font-medium tracking-tight text-violet-600 max-lg:text-center">
        ...
        <div className="relative max-lg:row-start-1">
          ...
          <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] max-lg:rounded-t-[calc(2rem+1px)]">
            <div className="px-8 pt-8 sm:px-10 sm:pt-10">
              <p className="mt-2 text-lg font-medium tracking-tight max-lg:text-center text-violet-600">
                Log Your Exercises
              </p>
              <p className="mt-2 max-w-lg text-sm/6 text-zinc-600 max-lg:text-center">
        ...
        <div className="relative max-lg:row-start-3 lg:col-start-2 lg:row-start-2">
          ...
          <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)]">
            <div className="px-8 pt-8 sm:px-10 sm:pt-10">
              <p className="mt-2 text-lg font-medium tracking-tight text-violet-600 max-lg:text-center">Count Your Reps</p>
              <p className="mt-2 max-w-lg text-sm/6 text-zinc-600 max-lg:text-center">
              ...
              <div className="absolute bottom-0 left-10 right-0 top-10 overflow-hidden rounded-tl-xl bg-gray-900 shadow-2xl">
                <div className="flex bg-gray-800/40 ring-1 ring-white/5">
                  <div className="-mb-px flex text-sm/6 font-medium text-gray-400">
                    ...
                    <div className="border-r border-gray-600/10 px-4 py-2">Workout Plan</div>
                  </div>
                </div>
